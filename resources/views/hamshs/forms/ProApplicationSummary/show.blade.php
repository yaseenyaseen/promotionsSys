        ...
        <div class="col-lg-12 margin-tb">
            ...
            {{--   <div class="pull-right">
                ...
                <div class="form-group col-sm-12 col-md-6 col-lg-12">
                    ...
                    {{date('Y-m-d',trim(strtotime( $Form->SessionNo_Date))) }}
                </div>
                <div class="form-group col-sm-12 col-md-6 col-lg-12">
                ...
                <div class="form-group col-sm-12 col-md-6 col-lg-12">
                    ...
                    {{date('Y-m-d',trim(strtotime( $Form->collegecouncil_SessDate))) }}
                </div>
                <div class="form-group col-sm-12 col-md-6 col-lg-12">
                ...
                <div class="form-group col-sm-12 col-md-6 col-lg-12">
                    ...
                    {{date('Y-m-d',trim(strtotime( $Form->Admin_OrderDate_UniHead_comm))) }}
                </div>
                <div class="form-group col-sm-12 col-md-6 col-lg-12">
