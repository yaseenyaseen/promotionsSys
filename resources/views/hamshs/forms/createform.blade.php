...
@section('content')
    ...
    <div dir="rtl">
        ...
        <h3 style="margin-top: 15px; text-align: center">أضافة بيانات جدول البحوث </h3>
        ...
        <form action="{{ route('editPaper') }}" method="POST">
            ...
            <div class="row">
                <div class="col-sm-12 col-md-8 col-lg-8">
                    ...
                    <select name="selected_option" id="select_option" style="width: 60%; height: 35px">
                        <option value="---">---</option>
                            ...
                            <div class="form-group col-sm-12 col-md-6 col-lg-6 py-2">
                                ...
                                <select class="form-control" name="publishType">
                                    <option value="1" {{ $selectedPaper->publishType==1? 'selected':"" }}>
                                        مجلات ذات معامل تأثير
                                    </option>
                                    <option value="2" {{ $selectedPaper->publishType==2? 'selected':"" }}>
                                        مجلات عالمية مطبوعة
                                    </option>
                                    <option value="3" {{ $selectedPaper->publishType==3? 'selected':"" }}>
                                        مجلات عربية وعراقية
                                    </option>
                                </select>
                            </div>
                   ...
                   $table->integer('headCommitee_ID')->nullable();
                      $table->timestamp('headCommitee_createdat')->nullable();--}}
                            ...
                            <div class="form-group col-sm-12 col-md-6 col-lg-12 py-2">
                                <label for="Ratio_paper_AppSuperlTheses">
                                    النسبة المئوية البحث مستل من رسالة أو اطروحة اشرف عليها طالب الترقية:
                                </label>
                            ...
                            <div class="form-group col-sm-12 col-md-12 col-lg-12 py-2">
                                <label for="plagiarised_resource_Sup">
                                    مصدر الاستلال من البحث مستل من رسالة أو اطروحة اشرف عليها طالب الترقية
                                </label>
                            ...
                            <div class="form-group col-sm-12 col-md-12 col-lg-12 py-2">
                                <label for="Ratio_paper_CoSuperTheses">
                                    النسبة المئوية البحث مستل من رسالة أو اطروحة اشرف عليها احد الباحثين المشاركين:
                                </label>
                                <input class="form-control" type="number" name="Ratio_paper_CoSuperTheses"
                                       id="Ratio_paper_CoSuperTheses"
   ...
   --}}
        ...
        @else
            ...
            <form action="{{ route('hamshs.forms.storef')}}" method="POST">
                <h3 style="margin-top: 15px; text-align: center">أدخال بحث جديد</h3>
                @csrf
                @role('Applicant')
                ...
                <div class="form-row">
                    <div class="form-group col-sm-12 col-md-12 col-lg-12 py-2">
                        <label for="paper_title">عنوان البحث</label>
                        <textarea class="form-control" style="height:80px" id="paper_title" name="paper_title"></textarea>
                    </div>
                    <div class="form-group col-sm-12 col-md-6 col-lg-4 py-2">
                ...
                <div class="form-row">
                    <div class="form-check col-sm-12 col-md-6 col-lg-4 py-3 py-2">
                    ...
                    <div class="form-group col-sm-12 col-md-6 col-lg-4 py-3 py-2">
                        <div class="form-check ">
                    ...
                    <div class="form-group col-sm-12 col-md-6 col-lg-6 py-3 py-2">
                        <label for="publishType">تصنيف جهة النشر </label>
                        <select class="form-control" id="publishType" name="publishType" style="width: 70%">
                 ...
                 $table->integer('headCommitee_ID')->nullable();
                    ...
                    <div class="form-group col-sm-12 col-md-12 col-lg-12 py-2">
                        <label for="plagiarised_Details">تفاصيل الاستلال</label>
                        <textarea class="form-control" style="height:80px" name="plagiarised_Details"></textarea>
                    </div>
                    <div class="form-group col-sm-12 col-md-6 col-lg-6 py-2">
                        <div class="form-check">
                    ...
                    <div class="form-group col-sm-12 col-md-12 col-lg-12 py-2">
                        <label for="plagiarised_resource">مصدر الاستلال</label>
                        <textarea class="form-control" style="height:80px" name="plagiarised_resource"></textarea>
                    </div>
                    <div class="form-group col-sm-12 col-md-12 col-lg-12 py-2">
                        <div class="form-check">
                    ...
                    <div class="form-group col-sm-12 col-md-12 col-lg-12 py-2">
                        <label for="plagiarised_resource_Sup">مصدر الاستلال من البحث مستل من رسالة أو اطروحة اشرف
                            عليها طالب
                            الترقية</label>
                        <textarea class="form-control" style="height:80px" name="plagiarised_resource_Sup"></textarea>
                    </div>
                    <div class="form-group col-sm-12 col-md-12 col-lg-12 py-2">
                        <div class="form-check">
                    ...
                    <div class="form-group col-sm-12 col-md-12 col-lg-12 py-2">
                        <label for="plagiarised_resource_CoSuper">مصدر الاستلال من البحث مستل من رسالة أو اطروحة
                            ...
                            احد
                            الباحثين المشاركين</label>
                        <textarea class="form-control" style="height:80px" name="plagiarised_resource_CoSuper"></textarea>
                    </div>
                    <div class="form-group col-sm-12 col-md-12 col-lg-12 py-2">
                        <div class="form-check">
                    ...
                    <div class="form-group col-sm-12 col-md-12 col-lg-12 py-2">
                        ...
                        <textarea class="form-control" style="height:80px" name="plagiarised_resource_CoTheses"></textarea>
                    </div>
                    <div class="form-group col-sm-12 col-md-12 col-lg-12 py-2">
                    ...
                    <div class="form-group col-sm-12 col-md-12 col-lg-12 py-2">
                        ...
                        <textarea class="form-control" style="height:80px" name="plagiarised_resource_OldProm"></textarea>
                    </div>
                    <div class="form-group col-sm-12 col-md-12 col-lg-12 py-2">
                    ...
                    <div class="form-group col-sm-12 col-md-12 col-lg-12 py-2">
                        ...
                        <textarea class="form-control" style="height:80px" name="plagiarised_resFrom_Others"></textarea>
                    </div>
                    <div class="form-group col-sm-12 col-md-12 col-lg-12 py-2">
                    ...
                    <div class="form-group col-sm-12 col-md-6 col-lg-12 py-2">
                        ...
                        <textarea class="form-control" style="height:80px" name="journalName"></textarea>
                    </div>
                    <div class="form-group col-sm-12 col-md-6 col-lg-4 py-2">
                        <label for="journalIssueNa">
                            عدد المجلة:
                    ...
                    <div class="form-group col-sm-12 col-md-12 col-lg-12 py-2">
                        ...
                        <textarea class="form-control" style="height:80px" name="ExpertEssessment1"></textarea>
                    </div>
                    <div class="form-group col-sm-12 col-md-12 col-lg-12 py-2">
                        <label for="ExpertEssessment2">
                            تقييم خبير2:
                        </label>
                        <textarea class="form-control" style="height:80px" name="ExpertEssessment2"></textarea>
                    </div>
                    <div class="form-group col-sm-12 col-md-12 col-lg-12 py-2">
                        <label for="ExpertEssessment3">
                            تقييم خبير3:
                    ...
                    <div class="form-group col-sm-12 col-md-12 col-lg-12 py-2">
                        ...
                        <textarea class="form-control" style="height:80px" name="TotalExpertEsses"></textarea>
                    </div>
                    <div class="form-check col-sm-12 col-md-12 col-lg-12 py-2">
                    ...
                    <div class="form-group col-sm-12 col-md-6 col-lg-6 py-2">
                        ...
                        <input class="form-control" type="date" id="suppPaper_dateof_application" name="suppPaper_dateof_application">
                    </div>
                    <div class="form-check col-sm-12 col-md-12 col-lg-12 py-2">
